...
const webgl = new WebGLApp({
  ...
  controls: {
    ...
    displacement: new State.Slider(3.5, { min: 0, max: 2, step: 0.01 }),
    ...
    turbulence: {
      ...
      amplitude: new State.Slider(0.0, { min: 0, max: 4, step: 0.01 }),
...
assets.load({ renderer: webgl.renderer }).then(() => {
  ...
  webgl.scene.slides = new Slides(webgl, { firstImage, otherImages: IMAGES, Slide: SlideSine, shape: config.shape, mouseBlob: config.mouseBlob })
